...
def collate_fn(data_list: list[dict]) -> dict:
    ...
    # Create a DocumentIndexer for each sample using the 'information' field
    if 'information' in non_tensors:
        output['indexers'] = [DocumentIndexer(info) for info in non_tensors['information']]
    else:
        output['indexers'] = [None for _ in data_list]  # fallback if not present
